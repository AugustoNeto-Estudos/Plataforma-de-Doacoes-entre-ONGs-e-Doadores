...
from dao.feedback import buscar_feedbacks_por_doador   # 🔹 Import para feedbacks
...
def pedidos_doador():
    ...
    return render_template("pedidosDoador.html",
        ...
        mapa_feedbacks=mapa_feedbacks   # 🔹 Agora o template recebe essa variável
    )
