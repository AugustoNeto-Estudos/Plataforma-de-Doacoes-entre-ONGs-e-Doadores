        ...
        with conexao.cursor() as cursor:
            ...
            for item in itens:
                valores = (
                    ...
                    item.get("observacao")  # pode ser None
                )
...
def listar_itens_intencao(id_intencao):
    try:
        ...
        st.error(f"❌ Erro ao listar itens da intenção: {str(erro).strip()[:200]}")
        return []
...
# ---------------------------
# UPDATE - Atualizar quantidade_pretendida e/ou observacao de um item
# ---------------------------
    ...
    try:
        ...
        with conexao.cursor() as cursor:
            ...
            if cursor.rowcount:
                ...
                return False, "⚠️ Item não encontrado nesta intenção."
