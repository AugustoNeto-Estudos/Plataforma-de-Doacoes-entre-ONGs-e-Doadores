...
if submit_create:
    if not id_pedido or not id_item:
        feedback_create.warning("⚠️ ID do pedido e ID do item são obrigatórios.")
    else:
...
if st.button("📥 Carregar itens"):
    ...
    if dados:
        ...
        feedback_read.info("Nenhum item encontrado para este pedido.")
